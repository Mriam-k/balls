...
void MoveBalls ()
    {
    int x  = 320, x1 = 360, x2 = 390, x3 = 420, x4 = 450, x5 = 490;
    int y  = 110, y1 = 150, y2 = 190, y3 = 230, y4 = 260, y5 = 300;
    int dt = 2;
    int vx  = 0, vy  = 0;
    int vx1 = 2, vy1 = 2, vx2 = 3, vy2 = 6, vx3 = 4, vy3 = 1, vx4 = 5, vy4 = 7, vx5 = 3, vy5 = 2;
    int balli = 0;
    ...
    while (!txGetAsyncKeyState (VK_ESCAPE))
        ...
        Count (&counter, &level, &vx1, &vy1, &vx2, &vy2, &vx3, &vy3, &vx4, &vy4, &vx5, &vy5);

        MoveStrategiyaBall (&x,  &y,  &vx,  &vy,  dt);
        MoveStrategiyaBall (&x1, &y1, &vx1, &vy1, dt);
        ...
        DrowBall (x,  y,  20, RGB (0,   255, 50 ), RGB (0,   128, 0  ));
        DrowBall (x1, y1, 20, RGB (63,  72,  204), RGB (63,  0,   255));
